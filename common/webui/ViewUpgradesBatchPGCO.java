 ...
 * Controller for ...
 */
public class ViewUpgradesBatchPGCO extends CommonSummaryBatchPGCO
{
  ...
  public void processRequest(OAPageContext pageContext, OAWebBean webBean)
  {
    ...
    pageContext.getPageLayoutBean().setTitle("Upgrades Batch ID: " + getBatchIdForThisPage() );
    pageContext.getPageLayoutBean().setWindowTitle("Upgrades Batch ID: " + getBatchIdForThisPage() );
  }
