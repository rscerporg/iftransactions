 ...
 * Controller for ...
 */
public class ViewMoneyBackBatchPGCO extends CommonSummaryBatchPGCO
{
  ...
  public void processRequest(OAPageContext pageContext, OAWebBean webBean)
  {
    ...
    pageContext.getPageLayoutBean().setTitle("One Year Money Back Batch ID: " + getBatchIdForThisPage() );
    pageContext.getPageLayoutBean().setWindowTitle("One Year Money Back Batch ID: " + getBatchIdForThisPage() );    
  }
