 ...
 * Controller for ...
 */
public class IFTransactionsAdminApproveThisBatchPGCO extends OAControllerImpl
{
  ...
  public void processRequest(OAPageContext pageContext, OAWebBean webBean)
  {
    ...
    pageContext.writeDiagnostics(this, "Entering IFTransactionsAdminApproveThisBatchPGCO.processRequest() ", 2);
    ...
    oam.invokeMethod("initIFTransactionsAdminApproveThisBatchPGCO", paramsToAM); 
  ...
  public void processFormRequest(OAPageContext pageContext, OAWebBean webBean)
  {
    ...
    pageContext.writeDiagnostics(this, "Entering IFTransactionsAdminApproveThisBatchPGCO.processFormRequest() ", 2);
    ...
    {   
      ...
      OAException confirmMessage = new OAException("PO", "RSC_OSS_IFB_ADMIN_BATCH_RJCT", messageTokensObj, OAException.CONFIRMATION, null);
    ...
    {   
      ...
      MessageToken[] messageTokensObj = { new MessageToken("THIS_BATCH_NUMBER", getBatchIdForThisPage()) } ;
      OAException confirmMessage = new OAException("PO", "RSC_OSS_IFB_ADMIN_BATCH_APRV", messageTokensObj, OAException.CONFIRMATION, null);
      pageContext.putDialogMessage(confirmMessage);      
